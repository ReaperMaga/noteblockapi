...
public class NoteBlockPlayerMain {
	...
	public void doSync(Runnable runnable) {
		Bukkit.getServer().getScheduler().runTask(NoteBlockAPI.getAPI().getServerPlugin(), runnable);
	}

	public void doAsync(Runnable runnable) {
		Bukkit.getServer().getScheduler().runTaskAsynchronously(NoteBlockAPI.getAPI().getServerPlugin(), runnable);
	}
